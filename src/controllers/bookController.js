...
const getBookAuthorId = async function (req, res) {
...
const getAuthorName=async function(req,res){
    ...
    const updatedPrice=await BookModel.findOneAndUpdate({name:"Two states"},{$set:{price:100}},{ new: true }).select({price:1,_id:0})
...
module.exports.getBookAuthorId = getBookAuthorId;
